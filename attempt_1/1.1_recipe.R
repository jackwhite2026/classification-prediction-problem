...
classification_recipe_1 <- recipe(host_is_superhost ~., data = train_classification) |> 
...
classification_recipe_1_check <- prep(classification_recipe_1) |>
  bake(new_data = NULL)

save(classification_recipe_1, file = here('attempt_1/results/classification_recipe_1.rda'))